...
--
-- Host: localhost
-- Generation Time: Jul 05, 2022 at 08:22 AM
...
(41, 'notice', 'notice', '2022-06-28 04:59:50', '2022-06-28 04:59:50'),
(42, 'More', 'group', '2022-06-28 09:07:33', '2022-06-28 09:07:33');
...
INSERT INTO `common_pages` (`id`, `title`, `discription`, `uploadto`, `image`, `created_at`, `updated_at`) VALUES
(15, 'this is about', 'bout', 'subcategory_id_28', '/images/common_page/202206281508hotel.jpg', '2022-06-28 09:23:40', '2022-06-28 09:23:40'),
(16, 'kh', 'jkk', 'subcategory_id_28', '/images/common_page/202206281520constructor.jpeg', '2022-06-28 09:35:37', '2022-06-28 09:35:37');
...
--
-- Dumping data for table `galary_pages`
--

INSERT INTO `galary_pages` (`id`, `title`, `discription`, `uploadto`, `image`, `created_at`, `updated_at`) VALUES
(19, 'jlkjjl', 'ajkssdh', 'subcategory_id_27', '/images/gallary_page/202206281705managing director.jpg', '2022-06-28 11:20:52', '2022-06-28 11:20:52');
...
(12, 'CCMA', '2022-06-06', '9808059156', 'mddasgudiya1@gmail.com', 'Janakpur', 'CCMA College is an accredited institution for CA professional studies by the Institute of Chartered Accountants of Nepal (ICAN). Since its foundation, the institution has been providing quality CA education through intensive coaching classes under both ICAN and ICAI in all levels along with required professional services. The institution is thus a well recognized platform of toppers and CA alumni of the society. As of now CCMA has a pride of having more than 450 CAs produced and some of them have been already serving with us as the reputed faculty resources along with their practicing in CA Firms. CCMA strives for instilling the required academic exposures along with the dynamic and ethical professionalism to the students.', '/images/institute_details/202206281039CCMA.png', NULL, '2022-06-28 04:47:38', '2022-06-28 04:58:04');
...
CREATE TABLE `links` (
  ...
  `linkedln` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(13, 'Manoj das', 'mddasgudiya@gmail.com', '9808059156', 'asad', '2022-06-28 13:27:47', '2022-06-28 13:27:47');
...
(20, '2022_06_28_063933_create_success_students_table', 6);
...
--
-- Dumping data for table `notice_pages`
--

INSERT INTO `notice_pages` (`id`, `title`, `discription`, `uploadto`, `image`, `created_at`, `updated_at`) VALUES
(10, 'sasd', 'assadda', 'category_id_41', '/images/notice_page/202206281521security.jpeg', '2022-06-28 09:36:15', '2022-06-28 09:36:15');
...
CREATE TABLE `seos` (
  ...
  `discription` varchar(3000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `keyword` varchar(3000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `seos` (`id`, `title`, `discription`, `keyword`, `image`, `created_at`, `updated_at`) VALUES
(9, 'CCMA COLLEGE KATHMANDU', 'CCMA College is an accredited institution for CA professional studies by the Institute of Chartered Accountants of Nepal (ICAN). Since its foundation, the institution has been providing quality CA education through intensive coaching classes under both ICAN and ICAI in all levels along with required professional services. The institution is thus a well recognized platform of toppers and CA alumni of the society. As of now CCMA has a pride of having more than 450 CAs produced and some of them have been already serving with us as the reputed faculty resources along with their practicing in CA Firms. CCMA strives for instilling the required academic exposures along with the dynamic and ethical professionalism to the students.', 'ccma,ccma college, ccma kathmandu', '/images/seo/202206281029CCMA Picnic.jpg', '2022-06-28 04:41:27', '2022-06-28 04:45:05');
...
INSERT INTO `slidders` (`id`, `image`, `title`, `discription`, `created_at`, `updated_at`) VALUES
(9, '/images/slidder/202206281434choose-bd.jpg', 'This is slidder', 'sli', '2022-06-28 08:49:52', '2022-06-28 08:49:52');
...
(27, 'GALLARY', 'galary', '42', '2022-06-28 09:08:01', '2022-06-28 09:08:01'),
(28, 'common', 'common', '42', '2022-06-28 09:17:47', '2022-06-28 09:17:47');
...
CREATE TABLE `success_students` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(55) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rank` varchar(55) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `success_students` (`id`, `name`, `rank`, `message`, `image`, `created_at`, `updated_at`) VALUES
(2, 'Manoj das md', 'Developer', 'aslkdj', '/images/student/student_success/202206280717cleaning.jpg', '2022-06-28 01:26:18', '2022-06-28 01:32:56');
