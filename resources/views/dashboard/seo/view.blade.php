                                ...
                                <table class="table" style="margin-bottom: 2rem;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> {{$seo->title}} </td>
                                            <td>  <span class="name">{{substr($seo->discription,0,30)}}</span> </td>
                                            <td>  <span class="name">{{substr($seo->keyword,0,20)}}</span> </td>
                                            <td class="avatar">
                                                <div class="round-img">
                                                    <a href="#"><img class="rounded-circle" src="{{$seo->image}}" alt=""></a>
                                                </div>
                                            </td>
                                            <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="font-size:12px;">
                                                            <a class="dropdown-item" href="{{route('SeoEdit',$seo->id)}}">Edit</a>
                                                            <a class="dropdown-item" href="{{route('SeoDelete',$seo->id)}}">delete</a>
                                                        </div>
                                                        </div>                                                 
                                            </td>
                                        </tr>
