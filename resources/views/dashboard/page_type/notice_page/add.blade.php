@extends('layouts.dashboard')
            ...
            <!----------Contentes------------>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12">
                        <form action="{{route('NoticePageStore')}}" method="post" enctype="multipart/form-data">
                            @csrf
                        <div class="card">
  ...
  <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                                        ...
                                        <input type="text" name="title" class="form-control" value="{{$noticepage->title ?? ''}}">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea name="discription" type="text" class="form-control">{{$noticepage->discription ?? ''}}</textarea>
                                    </div>
                                    ...
                                    <div class="input-group">
                                       ...
                                       <select class="form-select" aria-label="Default select example" name="uploadto">
                                            ...
                                            @foreach($category as $cat)
                                                @if($cat->type!="group")
                                                 <option value="category_id_{{$cat->id}}" @if(isset($noticepage)) @if("category_id_".$cat->id==$noticepage->uploadto) selected @endif @endif>{{$cat->name}}</option>
                                                @endif
                                            @endforeach
                                              @foreach($subcategory as $sub)
                                                 <option value="subcategory_id_{{$sub->id}}"  @if(isset($noticepage)) @if("subcategory_id_".$cat->id==$noticepage->uploadto) selected @endif @endif>{{$sub->name}}</option>
                                            @endforeach                                          
                                        </select>
                                    </div>    
                                     <small class="form-text text-muted"> upload to page </small>
  ...
  <path d="M2.002 1a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2h-12zm12 1a1 1 0 0 1 1 1v6.5l-3.777-1.947a.5.5 0 0 0-.577.093l-3.71 3.71-2.66-1.772a.5.5 0 0 0-.63.062L1.002 12V3a1 1 0 0 1 1-1h12z"/>
                                        ...
                                        <input type="hidden" name="id" value="{{$noticepage->id ?? ''}}">
                                    </div>
